...
import org.processmining.plugins.log.xpathengine.XPathEngine;
...
public class XPathExecutorPanel extends JPanel {
	...
	public XPathExecutorPanel(final PluginContext context, final XLog log) throws IdentitiesMissingException, IOException {
		_log = log;
		_context = context;

...
public class LogCentralityVisualizerPlugin {
	...
	public JComponent visualize(PluginContext context, LogCentrality centrality) {
		return visualize(centrality, null);
	}

	public JComponent visualize(LogCentrality centrality, LogCentralityFilterParameters parameters) {
